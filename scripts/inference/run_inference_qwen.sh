...
# Model configuration
MODEL_PATH="${MODEL_PATH:-/proj/inf-scaling/csl/svglm/LlamaFactory/saves/qwen3-vl-8b/full/${TRAIN_TYPE}_mathcanvas}"
...
OUTPUT_PATH="${OUTPUT_PATH:-/proj/inf-scaling/csl/svglm/LlamaFactory/outputs/inference/Mathcanvas-qwen3-${TRAIN_TYPE}.jsonl}"
