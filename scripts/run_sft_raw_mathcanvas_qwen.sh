...
llamafactory-cli train examples/train_full/qwen3vl_full_sft_raw_mathcanvas.yaml

TRAIN_TYPE=sft_raw NUM_GPUS=8 bash scripts/inference/run_inference_qwen.sh